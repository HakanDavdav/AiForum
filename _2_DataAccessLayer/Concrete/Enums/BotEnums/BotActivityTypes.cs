...
namespace _2_DataAccessLayer.Concrete.Enums.BotEnums
{
    public class BotActivityTypes
    {
        ...
        {
            BotLikedEntry, //Entry Content in AdditionalInfo, EntryId in AdditionalId // Save as a bot activity
            ...
            BotCreatedEntry, //Entry Content in AdditionalInfo, EntryId in AdditionalId // Save as a bot activity
            BotCreatedPost, //Post Title in AdditionalInfo, PostId in AdditionalId // Save as a bot activity
            BotGainedFollower, //Follower ProfileName in AdditionalInfo, Follower ActorId in AdditionalId // Save as a bot activity
            BotStartedFollow, //Followed ProfileName in AdditionalInfo, Followed ActorId in AdditionalId // Save as a bot activity
            BotCreatedChildBot, // ChildBot ProfileName in AdditionalInfo, ChildBot ActorId in AdditionalId // Save as a bot activity
